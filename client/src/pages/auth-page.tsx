  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        {/* Form Section */}
        <div className="flex-1 p-4 sm:p-6 md:p-10 flex items-center justify-center bg-background">
        ...
        <div className="hidden md:flex flex-1 bg-primary p-6 md:p-10 flex-col justify-center text-primary-foreground">
          <div className="max-w-md mx-auto">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="flex-shrink-0 h-6 w-6 text-primary-foreground mr-3">
        ...
        <div className="bg-muted/50 p-5 md:hidden">
          <h3 className="text-lg font-semibold text-center mb-4 text-foreground">Key Features</h3>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-card p-3 rounded-lg shadow-sm flex flex-col items-center text-center">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </div>
              <span className="text-sm font-medium text-card-foreground">Account Management</span>
            </div>
            <div className="bg-card p-3 rounded-lg shadow-sm flex flex-col items-center text-center">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-sm font-medium text-card-foreground">Data Export</span>
            </div>
            <div className="bg-card p-3 rounded-lg shadow-sm flex flex-col items-center text-center">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-sm font-medium text-card-foreground">Advanced Filters</span>
            </div>
            <div className="bg-card p-3 rounded-lg shadow-sm flex flex-col items-center text-center">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <span className="text-sm font-medium text-card-foreground">Role-Based Access</span>
            </div>
          </div>
        </div>
      </div>
